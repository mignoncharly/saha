...
class CustomerNotification(models.Model):
    ...
    reference_code = models.CharField(max_length=50, blank=True, help_text="Linked request reference, if any")
...
class NotificationPreference(models.Model):
    ...
    language = models.CharField(max_length=10, default='fr')
    regions = models.CharField(max_length=500, blank=True, help_text="Comma-separated preferred pickup regions")
    ...
    def __str__(self):
        return f"Préférences {self.customer_id}"