...
Items 1-8 are complete. Items 6, 7, and 8 are independent admin/ops branches.
Item 8 adds no migration.
...
**Next: item 9 — Filter-aware CSV exports** (per `phase-9-plan.md`; no
migration). Branch off `main`.

Django 5.2 production deploy remains deferred for a maintenance window.

---

_Last updated: 2026-06-26 — item 8 DONE; next item 9._
